...
if __name__ == "__main__":
    ...
    save_dir = os.path.join('postprocessed_results', args.save_dir)

    layer_segmentationssave_dir = os.path.join(save_dir, time_str+model_tag, 'Layer_Segmentations')
    os.makedirs(layer_segmentationssave_dir, exist_ok=True)
    show_layer_segmentationssave_dir = os.path.join(save_dir, time_str+model_tag, 'Show_Layer_Segmentations')
